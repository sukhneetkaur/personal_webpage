...
###### Undergraduate Student Researcher (August 2018 - May 2019)
...
- Developed a program to predict the nature of a cancerous tumor (benign vs malignant) based on different ten different tumor attributes (such as size, growth rate, etc.) and also tested the accuracy of the program by comparing the predictions to actual results
- Implemented several data structures (Heap, Linked List, Stack, Queues, Binary Trees, Hash table) in Python
- Implemented sorting algorithms (Bubble sort, Selection sort, Merge sort, Insertion sort) in Python
- Designed an interactive class roster to manage the students enrolled and waitlisted utilizing class inheritance
- Developed a program which takes in DNAs codes and automatically generates complementary RNAs codes

## Poster Presentations

- Kaur, Sukhneet., Kovacs, Abigail., Hoxha, Megi., Adrian, Leighelle (November 2019). Effect of Nocodazole and Taxol on Microtubule and Mitochondrial Distribution in LLC-PK1 GFP-tubulin Cells. Presented at Woodard Lab at Mount Holyoke College, South Hadley, MA
- Kaur, Sukhneet., Marwah, Miel., Miner, Reina., Nguyen, Lauren (May 2020). Effect of Handedness and Reaction Time on N2pc. Presented at Couperus Lab at Mount Holyoke College, South Hadley, MA

## Job Experiences 

### Association of National Advertisers Educational Foundation
###### MADE 2020 Remote Intern (June 2020 - August 2020)

- Completed the Marketing and Advertisement Education Program certified by ANA Educational Foundation
- Discussed potential diverse projects in the market focused on human behavior research
- Designed a portable disinfecting product for masks and personal items; performed market analysis based on population demographics for Clorox Case Competition

### Psychology Department, Mount Holyoke College 
###### Statistics Teaching Assistant (January 2020 - May 2020)

- Offered tutoring hours and clarifying course-related doubts; provided 1:1 support as needed
- Supported the teaching staff with SPSS assistance during Statistics labs

### Accessibility Services, Mount Holyoke College
###### Accessibility Fellow (August 2018 - May 2019)

- Empowered differently able students both individually and in bootcamps to facilitate transition into college life
- Coordinate with departmental institutions and student organizations to make activities/events accessible for all
- Worked with and handled individual specific confidential information

## Leadership Experience

### Eye Care Medical Camps (Punjab, India)
###### Lead Coordinator (May 2016 - 2018)

- Organized free annual eye-check camps in collaboration with local eye-specialists for low income households, once every year
- Raised awareness for eye care in rural areas; this endeavor resulted in free 600+ eye check-ups, 200+ cataract operations

### Women in STEM, Mount Holyoke College 
###### Outreach Coordinator (May 2018 - Present)

- Curating opportunities for women in STEM, Business and Tech
- Identifying inspirational and prominent women leaders to interact with students

### Active Minds Organisation, Mount Holyoke College
###### Board Member (November 2018 - Present)

- Advocating for improving mental health on campus and organizes seminars with relevant guest speakers
- Organizing campus events to reduce mental stress in the community e.g. Annual suicide & Drug prevention walk
